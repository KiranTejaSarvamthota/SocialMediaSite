...
function sendMailForNewUser(){
  //$email = 'saiswaroop.alluri@gmail.com';
    $return_arrfinal = array();
      ...
      $mail->Username = 'saiswaroop.alluri@gmail.com';
      $mail->Password = 'Swaroop@12345';
      $mail->SMTPSecure= 'tls';
      $mail->setFrom("saiswaroop.alluri@gmail.com","Swaroop");
      $mail->AddAddress('saiswaroop.alluri@gmail.com');     // Add a recipient
      // Optional name
      $mail->isHTML(true);                                  // Set email format to HTML
      $mail->Subject = ' Secure passCode ';
      $mail->Body    =" Hi, <br> Email: sallu001@odu.edu <br />Pass Code: 12345<br />";
